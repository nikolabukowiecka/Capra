...
{mapCounts, mapExposures, mapSignal}] &,Range[Length[ibexHi]]
	...
	mapRatesMain = If[mapExposuresMain[[#]]==0,Null,mapSignalMain[[#]]/(mapExposuresMain[[#]])]&/@Range[Length[mapExposuresMain]];
	...
	mapENAFluxMain = If[mapExposuresMain[[#]]==0,Null,mapSignalMain[[#]]/(mapExposuresMain[[#]]*geometricFactor*centralEnergy)]&/@Range[Length[mapExposuresMain]];
